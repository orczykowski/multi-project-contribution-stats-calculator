...
import static pl.boringstuff.domain.project.ReportFormat.PDF;
import pl.boringstuff.domain.raport.ContributionReport;
import static pl.boringstuff.domain.raport.writer.PdfReportLabel.GENERAL_INFORMATION;
import static pl.boringstuff.domain.raport.writer.PdfReportLabel.PROJECT_CONTRIBUTION;
import static pl.boringstuff.domain.raport.writer.PdfReportLabel.TOTAL_CONTRIBUTION;
import static pl.boringstuff.domain.raport.writer.PdfReportLabel.USER_CONTRIBUTION;
