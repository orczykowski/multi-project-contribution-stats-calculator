...
import pl.boringstuff.calculator.CalculationParameters;
...
public class ConsoleArgsParser {
  ...
  private ReportFormat reportFormat(final Map<String, String> rawArgsMap) {
    return ReportFormat.valueOf(rawArgsMap.getOrDefault(REPORT_FORMAT, APP_DEFAULTS.REPORT_FORMAT.getValue()));
  }
