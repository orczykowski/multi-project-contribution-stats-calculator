...
public record UserContributionStats(User user,
    ...
    public UserContributionStats withDistribution(final ProjectDistributionStats distribution) {
        return new UserContributionStats(this.user, this.counts, distribution);
    }
