...
import pl.orczykowski.core.ProjectCalculationStatsResult
...
import pl.orczykowski.testutils.ContributionReportAssertion
...
class ContributionReportFactorySpec extends Specification {
    ...
    private def createCalculationResult(String projectName, List<UserContributionStats> contributionStats) {
        new ProjectCalculationStatsResult.Success(new ProjectStats(new Project("git@github.com:orczykowski/${projectName}.git", Set.of()), contributionStats))
    }
